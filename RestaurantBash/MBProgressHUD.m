...
- (void)layoutSubviews {
    ...
    CGRect textRect = [detailsLabel.text boundingRectWithSize:maxSize  options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:detailsLabel.font} context:nil];
